    ...
    for it, batch in enumerate(data_loader):
        ...
        with torch.cuda.amp.autocast(fp16_scaler is not None):
            ...
            if args.is_synth_train and args.is_pooled_fewshot:
                ...
                numerator = args.lambda_1 * n_real * loss_real + (1 - args.lambda_1) * n_synth * loss_synth
                denominator = args.lambda_1 * n_real + (1 - args.lambda_1) * n_synth

                if denominator == 0:
                    print("[ERROR] Denominator zero in loss calculation")
                    sys.exit(1)
