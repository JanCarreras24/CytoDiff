...
# Ensure START_RANGE is less than or equal to FINAL_END_RANGE
if [ $START_RANGE -le $FINAL_END_RANGE ]; then
...
echo "GPU: $GPU"
echo "SET_SPLIT: $SET_SPLIT"
echo "SPLIT_IDX: $SPLIT_IDX"
echo "DATASET: $DATASET"
echo "N_CLS: $N_CLS"
echo "FEWSHOT_SEED: $FEWSHOT_SEED"
echo "N_SHOT: $N_SHOT"
echo "NUM_TRAIN_EPOCH: $NUM_TRAIN_EPOCH"
