...
TEMPLATES_WBC = [
    "{} single white blood cell, highly detailed, under a microscope, stained with Giemsa/Wright stain, showing clear nucleus and cytoplasm, realistic texture, cytology slide, soft lighting, high resolution.",
    "{} white blood cell on a microscopic cytology slide, detailed morphology, nucleus and cytoplasm clearly visible, stained with hematological dyes, realistic cell structure.",
    "High-resolution microscopic image of a {} blood cell, medical laboratory setting, showing precise cellular features, nuclear shape well-defined, cytoplasmic granules (if applicable), cytology slide.",
    "{} cell in a blood smear, captured under high magnification, cytological staining evident, biological accuracy, cell details sharp, surrounded by a few red blood cells.",
    "{} white blood cell in a clinical pathology image, advanced microscopy, color-enhanced staining, ultra-detailed, cytology slide, professional medical quality.",
    "{} leukocyte, single-cell focus, professional medical photography, visible cellular components, cytology slide, no artifacts, perfect staining contrast.",
    "A digitally enhanced microscopic image of a {} cell, accurate morphology, realistic blood smear background, best resolution for medical research, cytology slide.",
]
...
CLASS_ABBREVIATIONS = {
    ...
    "Eosinophil": "EOS",
    "Smudge cell": "KSC",
    "Atypical Lymphocyte": "LYA",
    "Typical Lymphocyte": "LYT",
    "Metamyelocyte": "MMZ",
    "Monoblast": "MOB",
    "Monocyte": "MON",
    "Myelocyte": "MYB",
