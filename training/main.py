# -*- coding: utf-8 -*-
"""
Created on Thu Jul 18 23:54:40 2024
...
from util_data import SUBSET_NAMES, TEMPLATES_SMALL, TEMPLATES_WBC, PROMPTS_BY_CLASS
...
class DataDreamDataset(Dataset):
    def __init__(self,
        ...
        self.n_shot = n_shot
        # self.templates = TEMPLATES_WBC[:n_template]
        self.dataset_name = {
            "matek": "",
            "imagenet": "",
            "imagenet_100": "",
        ...
        if not self.fewshot_data_dir.exists():
            print('Few shot data dir: ', self.fewshot_data_dir);
    ...
    def get_instance_data_list(self):
        ...
        for cls_idx, classname in enumerate(SUBSET_NAMES[self.dataset]):
            ...
            prompts = [PROMPTS_BY_CLASS[classname]] * len(images_path)
